...
import { getAirQualityIndex, getPollen, getWeather, getCity } from "./api/API";
...
LogBox.ignoreLogs(["Require cycle: App.js -> components\Other.jsx -> App.js","Require cycles are allowed, but can result in uninitialized values. Consider refactoring to remove the need for a cycle.", "Error: Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: object. You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports."])
 ...
 const dispatch = useDispatch()
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      console.log(await AsyncStorage.getItem("@lat"));
  ...
  const getAQI = async () => {
    const { data } = await axios.get(getAirQualityIndex(lat, lon));
